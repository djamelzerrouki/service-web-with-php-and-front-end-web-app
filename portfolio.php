...
echo $name;
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">les Notes</span></h2>
...
$sql="SELECT note,module.name AS name
		...
		where etudiant.name = '$name' AND notes.etudiant_id = etudiant.id AND notes.module_id = module.id";
